    ...
    <div className="flex flex-col items-center text-start py-2 my-2 pb-80">
      ...
      <div className="flex flex-col bg-white border-2 p-4 m-2 w-11/12 lg:w-2/6 rounded-md">
        ...
        <div className="flex items-center justify-between py-2 my-2 font-medium text-sm text-[#707070]">
          <p>FRENTE DEL DNI</p>
          <label for="archivo1" className="custom-file-upload">
            Adjuntar foto{" "}
            <input
              type="file"
              id="archivo1"
        ...
        <div className="flex items-center justify-between py-2 my-2 font-medium text-sm text-[#707070]">
          <p>DORSO DEL DNI</p>
          <label for="archivo2" className="custom-file-upload">
            Adjuntar foto
            <input
              type="file"
              id="archivo2"
      ...
      <button className="py-2 my-2 lg:w-2/6 w-11/12 bg-[#3184e4] text-white font-semibold hover:bg-[#00478a] rounded-sm">
        <Link href="/friocalor/solicitar">ENVIAR</Link>
      </button>
    </div>
  );
};
